...
enemy_spawns = [None,(2650,1130),(1291,1100),[(700,700),(700,1090)],None,None]
class Enemy(arcade.Sprite):
    def __init__(self,x,y,image='Sprites\\angry_peanut.png',size=.3):
...
class Boss(Enemy):
    def __init__(self,x,y):
        super().__init__(x,y,image='Sprites\\boss_slime.png',size=.2)
        self.hp = 1000
        self.damage = 25
        self.speed = 0.5
