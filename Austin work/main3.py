...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.arrow_sound = arcade.load_sound(PATH + "/resources/music/arrow_sound.wav")
        self.sword_sound = arcade.load_sound(PATH + "/resources/music/sword_sound.wav")
        self.switch_sound = arcade.load_sound(PATH + "/resources/music/switch_sound.wav")
        self.angry_peanut_death_sound = arcade.load_sound(PATH + "/resources/music/angry_peanut_death_sound.wav")
        self.boss_death_sound = arcade.load_sound(PATH + "/resources/music/boss_death_sound.wav")
        self.player_death_sound = arcade.load_sound(PATH + "/resources/music/player_death_sound.wav")
        self.damage_taken_player_sound = arcade.load_sound(PATH + "/resources/music/damage_taken_player_sound.mp3")
        self.damage_taken_enemy_sound = arcade.load_sound(PATH + "/resources/music/damage_taken_enemy_sound.mp3")
        self.door_key_sound = arcade.load_sound(PATH + "/resources/music/door_key_sound.wav")
        self.wall_break_sound = arcade.load_sound(PATH + "/resources/music/wall_break_sound.wav")
        self.background_sound = arcade.load_sound(PATH + "/resources/music/background_music.wav")
        self.heart_sound = arcade.load_sound(PATH + "/resources/music/heart_sound.wav")
    ...
    def setup(self, map_change):
        ...
        # Set up the player
        self.player = sara.Sara(self.additional_hp)
    ...
    def on_update(self, delta_time):
        ...
        for item in self.enemies_shoot_list:
            ...
            for self.person in shot_list:
                ...
                self.additional_hp -= item.damage
                item.kill()
        ...
        for bad_guy in self.enemies_list:
            ...
            if arcade.check_for_collision(bad_guy,self.player):
                ...
                self.additional_hp -= bad_guy.damage
