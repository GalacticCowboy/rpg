...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.background_sound = arcade.load_sound(PATH + "/resources/music/background_music.mp3")
        self.heart_sound = arcade.load_sound(PATH + "/resources/music/heart_sound.wav")
        
        self.music_count = None
    ...
    def setup(self, map_change):
        ...
        # Set up the player
        self.player = sara.Sara(self.hp_difference)
    ...
    def on_update(self, delta_time):
        ...
        # Update the hp difference.
        self.hp_difference = self.player.hp - 100     
